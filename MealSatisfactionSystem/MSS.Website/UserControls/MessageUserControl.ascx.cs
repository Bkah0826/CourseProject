...
public partial class UserControl_MessageUserControl : System.Web.UI.UserControl
{
    ...
    private const string STR_TITLE_ICON_error = "glyphicon glyphicon-remove";
    ...
    /// <summary>
    /// Displays a message and title in the message panel with an error display
    /// </summary>
    /// <param name="title">Title for the panel</param>
    /// <param name="message">Text to display as the message</param>
    public void ShowInfoError(string title, string message)
    {
        ShowInfo(message, title, STR_TITLE_ICON_error, STR_PANEL_danger);
    }
